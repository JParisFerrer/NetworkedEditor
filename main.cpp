...
USAGE:
  fprintf(stderr,
          "Usage: %s [-p PORT] [-a ADDRESS] [-sp SEARCH_PORT] [--start]\n",
          argv[0]);
  fprintf(
      stderr,
  ...
  fprintf(
      stderr,
      "\tSEARCH_PORT: a string that is the port to attempt to connect to\n");
  fprintf(stderr,
          "\t--start: whether to start the server when the -a flag is set\n");
