...
/*Constructors*/
template <typename T> TextContainer<T>::TextContainer() {}
...
template <typename T> void TextContainer<T>::remove(size_t line, size_t index) {
  this->container.remove(line, index);
}

template <typename T> void TextContainer<T>::move(size_t line, size_t index) {
  this->container.move(line, index);
}

template <typename T> size_t TextContainer<T>::line_width(size_t line) {
  return this->container.line_width(line);
}

template <typename T> void TextContainer<T>::writeToFile(std::string fileName) {
...
template <typename T> std::pair<char *, size_t> TextContainer<T>::serialize() {
...
template <typename T> void TextContainer<T>::printDebug() {
  this->container.printDebug();
}

template <typename T> void TextContainer<T>::writeToFileDebug() {
